...
const data = {
  district: {
    ...
    name: 'Ansam',
    description:
      'Rooted in Khaleeji heritage and designed for modern family life, Ansam is a low-density coastal community built for privacy and ease. Walkable streets, shaded courtyards, and cycling paths connect homes to welcoming shared spaces, promoting a lifestyle that is both simple and sociable.',
        ...
        <ImageBackground
          ...
          <ScrollView
            ...
            <View style={[styles.logoContainer, $flexDirection(appLanguage)]}>
              <SvgRenderer src={ansam} style={{height: 33, width: 55}} />
            </View>
