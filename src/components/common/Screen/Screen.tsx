...
import { STICKY_HEADER_INDICES } from '@constants/index';
...
function useAutoPreset(props: AutoScreenProps) {
    ...
    function updateScrollState() {
        if (
            ...
            scrollViewContentHeight.current === 0
        ) {
            return;
        }
        ...
        const contentFitsScreen = (function () {
            if (point) {
                return (
                    scrollViewContentHeight.current <
                    scrollViewHeight.current - point
                );
            } else {
                return (
                    scrollViewContentHeight.current <
                    scrollViewHeight.current * percent
                );
            }
        })();
